    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The one where the bow bridge is located", "Central Park" },
                    { 2, 1, "The historical bridge in New York City", "Brooklyn Bridge" },
                    { 3, 2, "The historical school in Dumaguete City", "Silliman University" }
                });
